"""One source checkout: update, build, verify and select a version."""
...
from .source_versions import (DEFAULT_LINE, LINES, BuildEnvironment, Version,
                              _free, _mark, _marked, _size)
