...
| [Using a model directly](docs/direct-use.md) | Browser actions for chat, images, music, configurable speech, audio analysis and OCR; current limits for library-only models. |
